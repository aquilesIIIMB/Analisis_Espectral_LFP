...
elseif strcmp(registroLFP.reference_type, 'general') %% Referencia al promedio general
    ...
    for j = 1:largo_canales_eval 
        ...
        % Eliminacion de artefactos % De aqui se obtiene una señal sin artefactos, re
        ...
        registroLFP.channel(canales_eval(j)).data = zscore_deartifacted(data_referenciado,ind_fueraUmbral);

...
change_band_power_beta_high = power_measurements_MT(registroLFP, [20, 30], false, true, path);
...
change_band_power_beta = power_measurements_MT(registroLFP, [12, 30], false, true, path);
[sum_MSC_beta, coupling_strength_beta, delay_beta] = coherence_measurements(registroLFP, [12, 30], [false, false, false], true, path);
close all

change_band_power_beta_parkinson = power_measurements_MT(registroLFP, [8, 30], false, true, path);
...
change_band_power_gamma_low = power_measurements_MT(registroLFP, [30, 60], false, true, path);
...
change_band_power_gamma_high = power_measurements_MT(registroLFP, [60, 90], false, true, path);
...
change_band_power_gamma = power_measurements_MT(registroLFP, [30, 90], false, true, path);

...
power_measurements_IRASA(registroLFP, [8, 30], true, false, path);
...
change_band_power_delta = power_measurements_IRASA(registroLFP, [1, 4], false, false, path);
...
change_band_power_theta = power_measurements_IRASA(registroLFP, [4, 8], false, false, path);
...
change_band_power_alpha = power_measurements_IRASA(registroLFP, [8, 12], false, false, path);
...
change_band_power_beta_low = power_measurements_IRASA(registroLFP, [12, 20], false, false, path);
...
change_band_power_beta_high = power_measurements_IRASA(registroLFP, [20, 30], false, false, path);
...
change_band_power_beta = power_measurements_IRASA(registroLFP, [12, 30], false, false, path);
...
change_band_power_beta_parkinson = power_measurements_IRASA(registroLFP, [8, 30], false, false, path);
...
change_band_power_gamma_low = power_measurements_IRASA(registroLFP, [30, 60], false, false, path);
...
change_band_power_gamma_high = power_measurements_IRASA(registroLFP, [60, 90], false, false, path);
...
change_band_power_gamma = power_measurements_IRASA(registroLFP, [30, 90], false, false, path);
...
[power_band_total, power_band_total_norm, fractal_power,power_fractal_norm] = power_total_measurements_IRASA(registroLFP, false, false, path);

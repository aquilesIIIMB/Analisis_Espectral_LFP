...
for i=1:num_areas_izq-1
    ...
    for j = num_areas_izq:-1:p
        ...
        C = registroLFP.average_sync{i,j}.coherenciogram.mag;
        f = registroLFP.average_sync{i,j}.coherenciogram.frequency;
        t = registroLFP.average_sync{i,j}.coherenciogram.time;
        
        Mean_C_pre = registroLFP.average_sync{i,j}.coherenciogram.mean_mag_pre;
        Desv_C_pre = registroLFP.average_sync{i,j}.coherenciogram.std_mag_pre;
        
        C_norm = (C-ones(size(C))*diag(Mean_C_pre))./(ones(size(C))*diag(Desv_C_pre));  

        Coherence_pre_mean = registroLFP.average_sync{i,j}.coherence.pre;
        Coherence_on_mean = registroLFP.average_sync{i,j}.coherence.on;
        Coherence_post_mean = registroLFP.average_sync{i,j}.coherence.post;
        ...
        title(['Coherenciogram multitaper between ','areas ',registroLFP.average_sync{i,j}.areas{1},' & ',registroLFP.average_sync{i,j}.areas{2}], 'FontSize', 24)
        ylabel(c,'Coherence', 'FontSize', 17)
        set(c,'fontsize',17)       
        name_figure_save = [inicio_foldername,'Images',foldername,slash_system,'Coherenciograms',slash_system,'Areas ',registroLFP.average_sync{i,j}.areas{1},' & ',registroLFP.average_sync{i,j}.areas{2},' coherenciograma multitaper'];
        ...
        lgd.FontSize = 20;
        title(['Coherence between ','areas ',registroLFP.average_sync{i,j}.areas{1},' & ',registroLFP.average_sync{i,j}.areas{2}], 'FontSize', 24)         
        name_figure_save = [inicio_foldername,'Images',foldername,slash_system,'Coherenciograms',slash_system,'Areas ',registroLFP.average_sync{i,j}.areas{1},' & ',registroLFP.average_sync{i,j}.areas{2},' promedio coherence'];
...
for i=1:num_areas_der-1
    ...
    for j = num_areas_der:-1:p
        ...
        C = registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.coherenciogram.mag;
        ...
        Mean_C_pre = registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.coherenciogram.mean_mag_pre;
        Desv_C_pre = registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.coherenciogram.std_mag_pre;
        
        C_norm = (C-ones(size(C))*diag(Mean_C_pre))./(ones(size(C))*diag(Desv_C_pre));  

        Coherence_pre_mean = registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.coherence.pre;
        Coherence_on_mean = registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.coherence.on;
        Coherence_post_mean = registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.coherence.post;
        ...
        line([on_final_m*60.0 on_final_m*60.0], get(gca, 'ylim'),'Color','white','LineWidth',3.5,'Marker','.','LineStyle','-');
        line([post_m*60.0 post_m*60.0], get(gca, 'ylim'),'Color','white','LineWidth',3.5,'Marker','.','LineStyle','-');
        title(['Coherenciogram multitaper between ','areas ',registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.areas{1},' & ',registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.areas{2}], 'FontSize', 24)
        ylabel(c,'Coherence', 'FontSize', 17)
        set(c,'fontsize',17)
        name_figure_save = [inicio_foldername,'Images',foldername,slash_system,'Coherenciograms',slash_system,'Areas ',registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.areas{1},' & ',registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.areas{2},' coherenciograma multitaper'];
        ...
        lgd = legend('pre-stim','on-stim','post-stim');
        lgd.FontSize = 20;
        title(['Coherence between ','areas ',registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.areas{1},' & ',registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.areas{2}], 'FontSize', 24)
        name_figure_save = [inicio_foldername,'Images',foldername,slash_system,'Coherenciograms',slash_system,'Areas ',registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.areas{1},' & ',registroLFP.average_sync{i+num_areas_izq,j+num_areas_izq}.areas{2},' promedio coherence'];

...
for m = 1:length(C)
    ...
    if strcmp(area(end),area_lesionada)
        ...
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.theta(idx_registerName+1).pre = sum_MSC_theta(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.theta(idx_registerName+1).on = sum_MSC_theta(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.theta(idx_registerName+1).post = sum_MSC_theta(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.alpha(idx_registerName+1).pre = sum_MSC_alpha(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.alpha(idx_registerName+1).on = sum_MSC_alpha(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.alpha(idx_registerName+1).post = sum_MSC_alpha(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.beta_low(idx_registerName+1).pre = sum_MSC_beta_low(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.beta_low(idx_registerName+1).on = sum_MSC_beta_low(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.beta_low(idx_registerName+1).post = sum_MSC_beta_low(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.beta_high(idx_registerName+1).pre = sum_MSC_beta_high(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.beta_high(idx_registerName+1).on = sum_MSC_beta_high(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.beta_high(idx_registerName+1).post = sum_MSC_beta_high(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.beta(idx_registerName+1).pre = sum_MSC_beta(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.beta(idx_registerName+1).on = sum_MSC_beta(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.beta(idx_registerName+1).post = sum_MSC_beta(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.beta_parkinson(idx_registerName+1).pre = sum_MSC_beta_parkinson(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.beta_parkinson(idx_registerName+1).on = sum_MSC_beta_parkinson(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.beta_parkinson(idx_registerName+1).post = sum_MSC_beta_parkinsona(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.gamma_low(idx_registerName+1).pre = sum_MSC_gamma_low(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.gamma_low(idx_registerName+1).on = sum_MSC_gamma_low(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.gamma_low(idx_registerName+1).post = sum_MSC_gamma_low(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.gamma_high(idx_registerName+1).pre = sum_MSC_gamma_high(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.gamma_high(idx_registerName+1).on = sum_MSC_gamma_high(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.gamma_high(idx_registerName+1).post = sum_MSC_gamma_high(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.gamma(idx_registerName+1).pre = sum_MSC_gamma(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.gamma(idx_registerName+1).on = sum_MSC_gamma(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.sum_MSC.gamma(idx_registerName+1).post = sum_MSC_gamma(idx_areas_injured(idx_injured+1), 3);

        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.theta(idx_registerName+1).pre = coupling_strength_theta(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.theta(idx_registerName+1).on = coupling_strength_theta(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.theta(idx_registerName+1).post = coupling_strength_theta(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.alpha(idx_registerName+1).pre = coupling_strength_alpha(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.alpha(idx_registerName+1).on = coupling_strength_alpha(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.alpha(idx_registerName+1).post = coupling_strength_alpha(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.beta_low(idx_registerName+1).pre = coupling_strength_beta_low(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.beta_low(idx_registerName+1).on = coupling_strength_beta_low(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.beta_low(idx_registerName+1).post = coupling_strength_beta_low(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.beta_high(idx_registerName+1).pre = coupling_strength_beta_high(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.beta_high(idx_registerName+1).on = coupling_strength_beta_high(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.beta_high(idx_registerName+1).post = coupling_strength_beta_high(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.beta(idx_registerName+1).pre = coupling_strength_beta(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.beta(idx_registerName+1).on = coupling_strength_beta(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.beta(idx_registerName+1).post = coupling_strength_beta(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.beta_parkinson(idx_registerName+1).pre = coupling_strength_beta_parkinson(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.beta_parkinson(idx_registerName+1).on = coupling_strength_beta_parkinson(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.beta_parkinson(idx_registerName+1).post = coupling_strength_beta_parkinson(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.gamma_low(idx_registerName+1).pre = coupling_strength_gamma_low(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.gamma_low(idx_registerName+1).on = coupling_strength_gamma_low(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.gamma_low(idx_registerName+1).post = coupling_strength_gamma_low(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.gamma_high(idx_registerName+1).pre = coupling_strength_gamma_high(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.gamma_high(idx_registerName+1).on = coupling_strength_gamma_high(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.gamma_high(idx_registerName+1).post = coupling_strength_gamma_high(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.gamma(idx_registerName+1).pre = coupling_strength_gamma(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.gamma(idx_registerName+1).on = coupling_strength_gamma(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.coupling_strength.gamma(idx_registerName+1).post = coupling_strength_gamma(idx_areas_injured(idx_injured+1), 3);

        protocoloLFP.injured(idx_injured+1).coherence_record.delay.theta(idx_registerName+1).pre = delay_theta(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.theta(idx_registerName+1).on = delay_theta(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.theta(idx_registerName+1).post = delay_theta(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.alpha(idx_registerName+1).pre = delay_alpha(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.alpha(idx_registerName+1).on = delay_alpha(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.alpha(idx_registerName+1).post = delay_alpha(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.beta_low(idx_registerName+1).pre = delay_beta_low(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.beta_low(idx_registerName+1).on = delay_beta_low(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.beta_low(idx_registerName+1).post = delay_beta_low(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.beta_high(idx_registerName+1).pre = delay_beta_high(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.beta_high(idx_registerName+1).on = delay_beta_high(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.beta_high(idx_registerName+1).post = delay_beta_high(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.beta(idx_registerName+1).pre = delay_beta(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.beta(idx_registerName+1).on = delay_beta(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.beta(idx_registerName+1).post = delay_beta(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.beta_parkinson(idx_registerName+1).pre = delay_beta_parkinson(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.beta_parkinson(idx_registerName+1).on = delay_beta_parkinson(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.beta_parkinson(idx_registerName+1).post = delay_beta_parkinson(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.gamma_low(idx_registerName+1).pre = delay_gamma_low(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.gamma_low(idx_registerName+1).on = delay_gamma_low(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.gamma_low(idx_registerName+1).post = delay_gamma_low(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.gamma_high(idx_registerName+1).pre = delay_gamma_high(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.gamma_high(idx_registerName+1).on = delay_gamma_high(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.gamma_high(idx_registerName+1).post = delay_gamma_high(idx_areas_injured(idx_injured+1), 3);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.gamma(idx_registerName+1).pre = delay_gamma(idx_areas_injured(idx_injured+1), 1);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.gamma(idx_registerName+1).on = delay_gamma(idx_areas_injured(idx_injured+1), 2);
        protocoloLFP.injured(idx_injured+1).coherence_record.delay.gamma(idx_registerName+1).post = delay_gamma(idx_areas_injured(idx_injured+1), 3);
    ...
    elseif strcmp(area(end),area_nolesionada)
        ...
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.theta(idx_registerName+1).pre = sum_MSC_theta(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.theta(idx_registerName+1).on = sum_MSC_theta(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.theta(idx_registerName+1).post = sum_MSC_theta(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.alpha(idx_registerName+1).pre = sum_MSC_alpha(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.alpha(idx_registerName+1).on = sum_MSC_alpha(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.alpha(idx_registerName+1).post = sum_MSC_alpha(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.beta_low(idx_registerName+1).pre = sum_MSC_beta_low(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.beta_low(idx_registerName+1).on = sum_MSC_beta_low(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.beta_low(idx_registerName+1).post = sum_MSC_beta_low(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.beta_high(idx_registerName+1).pre = sum_MSC_beta_high(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.beta_high(idx_registerName+1).on = sum_MSC_beta_high(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.beta_high(idx_registerName+1).post = sum_MSC_beta_high(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.beta(idx_registerName+1).pre = sum_MSC_beta(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.beta(idx_registerName+1).on = sum_MSC_beta(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.beta(idx_registerName+1).post = sum_MSC_beta(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.beta_parkinson(idx_registerName+1).pre = sum_MSC_beta_parkinson(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.beta_parkinson(idx_registerName+1).on = sum_MSC_beta_parkinson(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.beta_parkinson(idx_registerName+1).post = sum_MSC_beta_parkinsona(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.gamma_low(idx_registerName+1).pre = sum_MSC_gamma_low(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.gamma_low(idx_registerName+1).on = sum_MSC_gamma_low(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.gamma_low(idx_registerName+1).post = sum_MSC_gamma_low(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.gamma_high(idx_registerName+1).pre = sum_MSC_gamma_high(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.gamma_high(idx_registerName+1).on = sum_MSC_gamma_high(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.gamma_high(idx_registerName+1).post = sum_MSC_gamma_high(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.gamma(idx_registerName+1).pre = sum_MSC_gamma(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.gamma(idx_registerName+1).on = sum_MSC_gamma(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.sum_MSC.gamma(idx_registerName+1).post = sum_MSC_gamma(idx_areas_uninjured(idx_uninjured+1), 3);

        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.theta(idx_registerName+1).pre = coupling_strength_theta(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.theta(idx_registerName+1).on = coupling_strength_theta(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.theta(idx_registerName+1).post = coupling_strength_theta(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.alpha(idx_registerName+1).pre = coupling_strength_alpha(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.alpha(idx_registerName+1).on = coupling_strength_alpha(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.alpha(idx_registerName+1).post = coupling_strength_alpha(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.beta_low(idx_registerName+1).pre = coupling_strength_beta_low(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.beta_low(idx_registerName+1).on = coupling_strength_beta_low(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.beta_low(idx_registerName+1).post = coupling_strength_beta_low(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.beta_high(idx_registerName+1).pre = coupling_strength_beta_high(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.beta_high(idx_registerName+1).on = coupling_strength_beta_high(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.beta_high(idx_registerName+1).post = coupling_strength_beta_high(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.beta(idx_registerName+1).pre = coupling_strength_beta(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.beta(idx_registerName+1).on = coupling_strength_beta(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.beta(idx_registerName+1).post = coupling_strength_beta(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.beta_parkinson(idx_registerName+1).pre = coupling_strength_beta_parkinson(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.beta_parkinson(idx_registerName+1).on = coupling_strength_beta_parkinson(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.beta_parkinson(idx_registerName+1).post = coupling_strength_beta_parkinson(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.gamma_low(idx_registerName+1).pre = coupling_strength_gamma_low(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.gamma_low(idx_registerName+1).on = coupling_strength_gamma_low(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.gamma_low(idx_registerName+1).post = coupling_strength_gamma_low(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.gamma_high(idx_registerName+1).pre = coupling_strength_gamma_high(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.gamma_high(idx_registerName+1).on = coupling_strength_gamma_high(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.gamma_high(idx_registerName+1).post = coupling_strength_gamma_high(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.gamma(idx_registerName+1).pre = coupling_strength_gamma(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.gamma(idx_registerName+1).on = coupling_strength_gamma(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.coupling_strength.gamma(idx_registerName+1).post = coupling_strength_gamma(idx_areas_uninjured(idx_uninjured+1), 3);

        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.theta(idx_registerName+1).pre = delay_theta(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.theta(idx_registerName+1).on = delay_theta(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.theta(idx_registerName+1).post = delay_theta(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.alpha(idx_registerName+1).pre = delay_alpha(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.alpha(idx_registerName+1).on = delay_alpha(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.alpha(idx_registerName+1).post = delay_alpha(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.beta_low(idx_registerName+1).pre = delay_beta_low(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.beta_low(idx_registerName+1).on = delay_beta_low(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.beta_low(idx_registerName+1).post = delay_beta_low(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.beta_high(idx_registerName+1).pre = delay_beta_high(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.beta_high(idx_registerName+1).on = delay_beta_high(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.beta_high(idx_registerName+1).post = delay_beta_high(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.beta(idx_registerName+1).pre = delay_beta(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.beta(idx_registerName+1).on = delay_beta(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.beta(idx_registerName+1).post = delay_beta(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.beta_parkinson(idx_registerName+1).pre = delay_beta_parkinson(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.beta_parkinson(idx_registerName+1).on = delay_beta_parkinson(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.beta_parkinson(idx_registerName+1).post = delay_beta_parkinson(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.gamma_low(idx_registerName+1).pre = delay_gamma_low(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.gamma_low(idx_registerName+1).on = delay_gamma_low(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.gamma_low(idx_registerName+1).post = delay_gamma_low(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.gamma_high(idx_registerName+1).pre = delay_gamma_high(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.gamma_high(idx_registerName+1).on = delay_gamma_high(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.gamma_high(idx_registerName+1).post = delay_gamma_high(idx_areas_uninjured(idx_uninjured+1), 3);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.gamma(idx_registerName+1).pre = delay_gamma(idx_areas_uninjured(idx_uninjured+1), 1);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.gamma(idx_registerName+1).on = delay_gamma(idx_areas_uninjured(idx_uninjured+1), 2);
        protocoloLFP.uninjured(idx_uninjured+1).coherence_record.delay.gamma(idx_registerName+1).post = delay_gamma(idx_areas_uninjured(idx_uninjured+1), 3);
